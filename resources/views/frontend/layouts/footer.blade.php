				...
				<div class="inner">
					<div class="row">
						<div class="col-lg-6 col-12">
							<div class="left">
								<p>{{ Lang::get('msg.copyright') }}{{date('Y')}} <a href="https://www.facebook.com/spansoftware" target="_blank">{{ Lang::get('msg.abdullahmostafa') }}</a>  -  {{ Lang::get('msg.allrightreserved') }}</p>
							</div>
						</div>
						<div class="col-lg-6 col-12">
							<div class="right">
