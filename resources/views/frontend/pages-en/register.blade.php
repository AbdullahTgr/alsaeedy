                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">{{ Lang::get('msg.register') }}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="login-form">
                        ...
                        <form class="form" method="post" action="{{route('register.submit')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>{{ Lang::get('msg.confirmpassword') }}<span>*</span></label>
                                ...
                                <div class="col-12">
                                    <div class="form-group login-btn">
                                        <button class="btn" type="submit">{{ Lang::get('msg.register') }}</button>
                                        <a href="{{route('login.form')}}" class="btn">{{ Lang::get('msg.login') }}</a>
                                        {{ Lang::get('msg.or') }}
