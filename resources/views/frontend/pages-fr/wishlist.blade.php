				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="javascript:void(0);">{{ Lang::get('msg.wishlist') }}</a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<table class="table shopping-summery">
						<thead>
							<tr class="main-hading">
								...
								<th class="text-center">{{ Lang::get('msg.addtocart') }}</th> 
							...
							@if(Helper::getAllProductFromWishlist())
								@foreach(Helper::getAllProductFromWishlist() as $key=>$wishlist)
									<tr>
										...
										<td><a href="{{route('add-to-cart',$wishlist->product['slug'])}}" class='btn text-white'>{{ Lang::get('msg.addtocart') }}</a></td>
							...
							@else 
								<tr>
									<td class="text-center">
										{{ Lang::get('msg.therearenowishlistavaliable') }} <a href="{{route('product-grids')}}" style="color:blue;">{{ Lang::get('msg.continueshopping') }}</a>
