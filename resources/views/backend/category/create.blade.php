    ...
    <div class="card-body">
      <form method="post" action="{{route('category.store')}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle-ar" type="text" name="title-ar" placeholder="العنوان"  value="{{old('title-ar')}}" class="form-control">
          @error('title')
...
<div class="col-xs-12 " style="background:#ddd">
  ...
  <div class="form-group">
    ...
    <input id="inputTitle-fr" type="text" name="title-fr" placeholder="العنوان"  value="{{old('title-fr')}}" class="form-control">
    @error('title-fr')
    <span class="text-danger">{{$message}}</span>
    @enderror
  </div>
