...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('shipping.update',$shipping->id)}}">
        ...
        <div class="form-group">
          <label for="inputTitle-ar" class="col-form-label">اسم شركة الشحن <span class="text-danger">*</span></label>
        <input id="inputTitle-ar" type="text" name="type-ar" placeholder=" اسم شركة الشحن"  value="{{$shipping->{'type-ar'} }}" class="form-control">
        @error('title-ar')
        <span class="text-danger">{{$message}}</span>
        @enderror
        </div>    
...
<div class="col-xs-12 " style="background:#ddd">
  ...
  <div class="form-group">
    <label for="inputTitle-fr" class="col-form-label">اسم شركة الشحن  بالفرنسي<span class="text-danger">*</span></label>
  <input id="inputTitle-fr" type="text" name="type-fr" placeholder=" اسم شركة الشحن بالفرنسي"  value="{{$shipping->{'type-fr'} }}" class="form-control">
  @error('title-fr')
  <span class="text-danger">{{$message}}</span>
  @enderror
  </div>    
